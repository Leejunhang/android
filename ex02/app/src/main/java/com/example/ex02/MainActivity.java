...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터 생성
        array=new ArrayList<>();
        ProductVO vo=new ProductVO(1, "AirPod",R.drawable.airpod, 330000);
        array.add(vo);
        vo=new ProductVO(2, "삼성 OLED",R.drawable.tv, 1500000);
        array.add(vo);
        vo=new ProductVO(3, "삼성 노트북",R.drawable.notebook, 1000000);
        array.add(vo);
        vo=new ProductVO(4, "삼성 테블릿",R.drawable.tab, 500000);
        array.add(vo);
    ...
    @Override
        public boolean onOptionsItemSelected(@NonNull MenuItem item) {
            ...
            return super.onOptionsItemSelected(item);  //뒤로가기 버튼 작동 
    }
}//Activity
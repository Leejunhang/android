...
public class MarketActivity extends AppCompatActivity {
    ...
    List<MarketVO> array=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnInsert).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MarketActivity.this, InsertActivity.class);
    ...
    class MarketAdapter extends RecyclerView.Adapter<MarketAdapter.ViewHolder>{
        ...
        public MarketAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view=getLayoutInflater().inflate(R.layout.item_market, parent, false);
            return new ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull MarketAdapter.ViewHolder holder, int position) {
                MarketVO vo=array.get(position);
                ...
                Picasso.with(MarketActivity.this).load(vo.getImage()).into(holder.image);
                holder.item.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(MarketActivity.this, ReadActivity.class);
